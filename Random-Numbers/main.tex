...
\begin{document}
	...
	\solution  Download the following python3 code that plots Fig. \ref{fig-1.2}
	\begin{lstlisting}
		wget https://github.com/LokeshBadisa/AI1110-Probability-and-Random-Variables/blob/main/Random-Numbers/codes/1.2.py
	\end{lstlisting}
	...
	\solution  Download the following python3 code that plots Fig. \ref{fig-5.3}
	\begin{lstlisting}
		wget https://github.com/LokeshBadisa/AI1110-Probability-and-Random-Variables/blob/main/Random-Numbers/codes/5.3.py
	\end{lstlisting}
	Run the code by executing
	\begin{lstlisting}
		python3 5.3.py
